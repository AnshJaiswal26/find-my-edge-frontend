...
const TradeDayDetails = ({ data }) => {
  ...
  if (!day) {
    return (
      <Container
        ...
        className="flex-3 w-full h-full items-center"
      >
  ...
  return (
    <Container className="w-full h-full flex-3 p-4! items-start">
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="overflow-x-auto p-3">
          <div className="w-full text-sm">
            <div className="grid grid-cols-7 border-y border-(--border-muted) sticky top-0 bg-(--surface)">
