...
export const columnsById = {
  date: createSchema({
    id: "date",
    label: "Date",
    type: SCHEMA_TYPE.DATE,
    semanticType: SEMANTIC_TYPE.DATE,
  ...
  entryTime: createSchema({
    id: "entryTime",
    label: "Entry Time",
    type: SCHEMA_TYPE.TIME,
    semanticType: SEMANTIC_TYPE.TIME,
    source: SCHEMA_SOURCE.SYSTEM,
    editable: true,
  ...
  duration: createSchema({
    id: "duration",
    label: "Duration",
    type: SCHEMA_TYPE.DURATION,
    semanticType: SEMANTIC_TYPE.DURATION, // important
  ...
  entry: createSchema({
    ...
    semanticType: SEMANTIC_TYPE.NUMBER,
    source: SCHEMA_SOURCE.SYSTEM,
    editable: true,
